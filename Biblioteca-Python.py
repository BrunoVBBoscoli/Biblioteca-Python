...
Livro = collections.namedtuple(
    "Livro", "Titulo Subtitulo Id Isbn Cdd Codigo_Autor Ediçao Autor Serie Volume Local_Publicaçao")
...
while 1:
    ...
    if (menu == 1):
        ...
        livros.append(Livro(titulo, subtitulo, indice, isbn, cdd,
                            codigo_autor, ediçao, autor, serie, volume, local_publicaçao))
        livros_ordenados.append(Livro(titulo, subtitulo, indice, isbn, cdd,
                                      codigo_autor, ediçao, autor, serie, volume, local_publicaçao))
    ...
    if (menu == 2):
        ...
        json.dump(salve, f, sort_keys=False, indent=2)
        f.close()
